...
const lecturerNavItems = [
  ...
  { icon: LayoutDashboard, label: "Overview", path: "/dashboard/lecturer/overview" },
...
const studentNavItems = [
  ...
  { icon: LayoutDashboard, label: "Planner", path: "/dashboard/student/planner" },
  { icon: LayoutDashboard, label: "Weekly Schedule", path: "/dashboard/student/weekly-schedule" },
  { icon: LayoutDashboard, label: "Progress", path: "/dashboard/student/progress" },
...
export default function DashboardLayout({ children, userType }: DashboardLayoutProps) {
  ...
  return (
    <div className="min-h-screen bg-background flex w-full relative overflow-hidden">
      <div className="absolute -top-24 -left-20 w-96 h-96 bg-secondary/10 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute -bottom-24 -right-20 w-[28rem] h-[28rem] bg-accent/10 rounded-full blur-3xl pointer-events-none" />
      <button
        className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-card/90 backdrop-blur border border-border shadow"
      ...
      <aside
        className={`fixed lg:static inset-y-0 left-0 z-40 w-72 bg-slate-950/95 backdrop-blur text-slate-100 border-r border-slate-800 transform transition-transform duration-300 ${
              ...
              return (
                <Link
                  ...
                  className={`flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 ${
                    isActive
                      ? "bg-slate-800/80 text-white shadow-soft border border-slate-700/70"
        ...
        <div className="p-6 lg:p-10">
          <div className="flex flex-col gap-4 mb-6">
            <div className="flex items-center justify-between gap-3">
              ...
              <div className="rounded-xl border border-border/60 bg-card/85 backdrop-blur px-4 py-2 shadow-soft">
